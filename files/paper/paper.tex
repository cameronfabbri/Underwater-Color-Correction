...
%\newcommand\animage{\adjustbox{valign=m,vspace=0pt}{\includegraphics[width=.2\linewidth]{n01496331_15872_original}}}
...
\section{Method}
In this section we propose our method for color restoration of underwater images. Depending on depth, lighting
conditions, camera, and location, the amount of distortion an image undergoes can vary.  Because ground truth pairs do
not exist for distorted underwater images, we use the recently proposed CycleGAN \cite{zhu2017unpaired} to generate
a paired dataset of images. CycleGAN has shown success in translating an image from domain $X$ to domain $Y$,
\textit{without} a paired sample. By letting $X$ be a set of underwater images 
