...
generator uses kernel size $4 \times 4$ with stride 2. Following \cite{radford2015unsupervised}, we use batch
normalization \cite{pmlr-v37-ioffe15} throughout except for the last layer of the decoder.
