...
\usepackage{graphicx}
\graphicspath{ {images/}{images/figure1/}{images/figure2/}{images/figure3} }
...
\begin{tabular}{p{1.7cm} p{1.7cm} p{1.7cm} p{1.7cm}}
   ...
   \includegraphics[width=0.8in]{ogcmp} &
   \includegraphics[width=0.8in]{cgan_cmp} &
   \includegraphics[width=0.8in]{ugan_cmp} &
   \includegraphics[width=0.8in]{uganp_cmp} \\
