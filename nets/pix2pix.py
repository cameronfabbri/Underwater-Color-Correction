...
def netG(x, LOSS_METHOD):
   ...
   if LOSS_METHOD is not 'wgan': dec_conv4 = tcl.batch_norm(dec_conv4)
   ...
   if LOSS_METHOD is not 'wgan': dec_conv5 = tcl.batch_norm(dec_conv5)
   ...
   if LOSS_METHOD is not 'wgan': dec_conv6 = tcl.batch_norm(dec_conv6)
   ...
   if LOSS_METHOD is not 'wgan': dec_conv7 = tcl.batch_norm(dec_conv7)
   ...
   if LOSS_METHOD is not 'wgan': dec_conv8 = tcl.batch_norm(dec_conv8)
