...
def netG(x, LOSS_METHOD):
   ...
   enc_conv1 = instance_norm(enc_conv1)
   ...
   enc_conv2 = instance_norm(enc_conv2)
   ...
   enc_conv3 = instance_norm(enc_conv3)
   ...
   enc_conv4 = instance_norm(enc_conv4)
   ...
   enc_conv5 = instance_norm(enc_conv5)
   ...
   enc_conv6 = instance_norm(enc_conv6)
   ...
   enc_conv7 = instance_norm(enc_conv7)
   ...
   enc_conv8 = instance_norm(enc_conv8)
   ...
   dec_conv1 = instance_norm(dec_conv1)
   ...
   dec_conv2 = instance_norm(dec_conv2)
   ...
   dec_conv3 = instance_norm(dec_conv3)
   ...
   dec_conv4 = instance_norm(dec_conv4)
   ...
   dec_conv5 = instance_norm(dec_conv5)
   ...
   dec_conv6 = instance_norm(dec_conv6)
   ...
   dec_conv7 = instance_norm(dec_conv7)
   ...
   dec_conv8 = instance_norm(dec_conv8)
